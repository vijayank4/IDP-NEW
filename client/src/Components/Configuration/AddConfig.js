            ...
            <div className={`row`}>
                <div className="col-md-6 col-sm-6 col-lg-6">
                    <div className="mb-2">
                        ...
                        <input type="text" className={`form-control`} id="tagname" name="tagname" placeholder="Enter the tag name" mandatory="true" onChange={handleChangeInput} />
                    </div>
                </div>
                <div className="col-md-6 col-sm-6 col-lg-6">
                    <div className="mb-2">
                        <label htmlFor="tagvalue" className="form-label">Value: <span style={{color:'red'}}>*</span></label>
                        <input type="text" className={`form-control`} id="tagvalue" name="tagvalue" placeholder="Enter the value" mandatory="true" onChange={(e) => Validation(e.target,'tagvalue')} />
                    </div>
                </div>
            </div>
